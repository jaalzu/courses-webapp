  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-100 dark:border-gray-800 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg sm:text-xl font-bold text-balance text-gray-900 dark:text-gray-100">
          ...
          topCourses.map((course, index) => (
            <div key={course.id} className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-8 h-8 rounded-full flex items-center justify-center font-bold tabular-nums text-gray-700 dark:text-gray-300">
                  {index + 1}
                </div>
                <p className="font-medium text-gray-900 dark:text-gray-100">{course.title}</p>
              </div>
              <p className="font-bold text-lg tabular-nums text-gray-900 dark:text-gray-100">
