...
export function UserStats({ 
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 text-balance">Tu Progreso</h2>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold tabular-nums">{inProgressCourses}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              ...
              <p className="text-3xl font-bold tabular-nums">{progressPercentage}%</p>
            </div>
          </div>
