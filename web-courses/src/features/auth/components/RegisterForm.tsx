    ...
    <div className="w-full max-w-sm space-y-6">
      ...
      <div className="space-y-3">
        <div className="relative w-full">
          ...
          <Input type="text" placeholder="Nombre completo" className="pl-10 w-full" />
        </div>

        <div className="relative w-full">
          <EnvelopeIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
          <Input type="email" placeholder="Correo electrónico" className="pl-10 w-full" />
        </div>

        <div className="relative w-full">
          <LockIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
          <Input type="password" placeholder="Contraseña" className="pl-10 w-full" />
        </div>

        <div className="relative w-full">
          <LockIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
          <Input type="password" placeholder="Confirmar contraseña" className="pl-10 w-full" />
        </div>
      </div>
